    ...
    return (
        <>
            <div className="flex flex-col items-center px-6">
                ...
                <p className="text-center text-sm text-neutral-600" dangerouslySetInnerHTML={ markup } />
            </div>
...
const AboutUs = () => {
    ...
    return(
        <section className="grid md:grid-cols-1 lg:grid-cols-2 gap-y-10 lg:gap-x-10 bg-sky-100/50 px-6 lg:px-24 py-12 lg:py-20 relative" id="about-us">
            ...
            <div className="w-56 h-56 lg:w-80 lg:h-80 rounded-full bg-yellow-500/50 blur-xxl absolute left-0 top-0 translate-x-1/2 translate-y-1/2 z-0 pointer-events-none"></div>
        </section>
    );
}
